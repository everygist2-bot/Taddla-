...
import { X, ShieldCheck, Mail, HelpCircle, FileText, BookOpen, Send, CheckCircle2, Loader2, AlertCircle } from 'lucide-react';
            ...
            {contactSubmitted ? (
              <div className="p-6 text-center bg-emerald-50 dark:bg-emerald-950/40 rounded-2xl border border-emerald-200">
                ...
                <p className="text-xs text-emerald-700 dark:text-emerald-300 mt-1">
                  Thank you for reaching out. Our support team will respond to {submittedEmail} within 24 hours.
                </p>
              </div>
            ) : (
              <form
              ...
              >
                {contactError && (
                  <div className="flex items-center gap-2 p-3 rounded-xl bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800 text-xs text-red-700 dark:text-red-300">
                ...
                <button
                  ...
                  className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-bold text-sm rounded-xl transition-colors cursor-pointer flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
