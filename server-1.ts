...
if (!admin.apps.length) {
  ...
  const serviceAccount = serviceAccountRaw ? JSON.parse(serviceAccountRaw) : undefined;
...
const db = admin.firestore('ai-studio-reviewpulse-3ec7577d-a9c7-4d71-b1aa-02aa1a28258b');
